...
?>
		...
		<td><center>
			<img src="<?php echo "images/".$hasil['nama']; ?>" class='apalah'></center>
		</td>		
        <td><center><?php echo $hasil['name']?></center></td>
        <td><center><?php echo $hasil['series']?></center></td>
        <td><center><?php echo $hasil['price']?></center></td>
        <td><center><a href='edit.php?id_figure=<?php echo $hasil["id_figure"] ?>'><button class="btn">Edit</button></a><br><a href='delete.php?id_figure=<?php echo $hasil["id_figure"] ?>'><button class="btn">Delete</button></a><a href='review.php?id_figure=<?php echo $hasil["id_figure"] ?>'><button class="btn">View</button></a>
        </center></td>
        </tr>
<?php
    }
